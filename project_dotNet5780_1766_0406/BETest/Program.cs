...
namespace BETest
{
    class Program
    {
        private static List<BE.GuestRequest> _guestRequestsList = new List<BE.GuestRequest>()
            {
        ...
        private static List<BE.HostingUnit> _hostingUnitsList = new List<BE.HostingUnit>()
            {
                new BE.HostingUnit()
                {
        ...
        private static List<BE.Order> _ordersList = new List<BE.Order>()
            {
                new BE.Order(){
        ...
        private static List<BE.BankBranch> _bankBranchList = new List<BE.BankBranch>()
            {
                new BE.BankBranch(){
                    BankName = "bank1",
                    BranchNumber = 1,
        ...
        private static void PrintBE()
        {
            foreach (var item in _guestRequestsList)
            {
            ...
            foreach (var item in _hostingUnitsList)
            {
                Console.WriteLine(item);
                Console.WriteLine();
            }
            ...
            foreach (var item in _bankBranchList)
            {
                Console.WriteLine(item);
                Console.WriteLine();
            }
